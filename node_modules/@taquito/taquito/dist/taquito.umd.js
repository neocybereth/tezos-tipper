(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taquito/rpc'), require('@taquito/signer'), require('rxjs'), require('rxjs/operators'), require('bignumber.js'), require('@taquito/utils'), require('@taquito/michelson-encoder'), require('@taquito/http-utils')) :
    typeof define === 'function' && define.amd ? define(['exports', '@taquito/rpc', '@taquito/signer', 'rxjs', 'rxjs/operators', 'bignumber.js', '@taquito/utils', '@taquito/michelson-encoder', '@taquito/http-utils'], factory) :
    (global = global || self, factory(global.taquito = {}, global.rpc, global.signer, global.rxjs, global.operators, global.BigNumber, global.utils, global.michelsonEncoder, global.httpUtils));
}(this, (function (exports, rpc, signer, rxjs, operators, BigNumber, utils, michelsonEncoder, httpUtils) { 'use strict';
            ...
            return __generator(this, function (_f) {
                ...
                contractCode = Array.isArray(code)
                    ? code.sort(function (a, b) {
                        return order.indexOf(a.prim) - order.indexOf(b.prim);
