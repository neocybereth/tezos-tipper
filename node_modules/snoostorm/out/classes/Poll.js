...
var Poll = /** @class */ (function (_super) {
    ...
    function Poll(_a) {
        var frequency = _a.frequency, get = _a.get, filter = _a.filter;
        ...
        _this.interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = async_1.filterAsync;
                        return [4 /*yield*/, get()];
                    case 1: return [4 /*yield*/, _a.apply(void 0, [_c.sent(), function (item, i) {
                                return filter(item, i, that.inventory);
                            }])];
                    case 2:
                        got = _c.sent();
